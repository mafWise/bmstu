...
echo -n "Введите минимальное количество элементов (etc -> 10000): "
read -r MIN_SIZE
...
echo -e -n "Введите максимальное количество элементов (etc -> 70000): "
read -r MAX_SIZE
...
if [ $((${MAX_SIZE} - ${MIN_SIZE})) -gt 70000 ]; then
...
echo -n -e "Введите шаг измерений (etc -> 500): "
read -r STEP
...
echo -n -e "Введите количество кругов тестирования (etc -> 50): "
read -r LAPS
